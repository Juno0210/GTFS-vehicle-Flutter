...
class TrackDirection extends $pb.ProtobufEnum {
  static const TrackDirection UP = TrackDirection._(0, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'UP');
  static const TrackDirection DOWN = TrackDirection._(1, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'DOWN');
  ...
  const TrackDirection._($core.int v, $core.String n) : super(v, n);
}
...
class TripUpdate_StopTimeUpdate_OccupancyStatus extends $pb.ProtobufEnum {
  static const TripUpdate_StopTimeUpdate_OccupancyStatus EMPTY = TripUpdate_StopTimeUpdate_OccupancyStatus._(0, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'EMPTY');
  static const TripUpdate_StopTimeUpdate_OccupancyStatus MANY_SEATS_AVAILABLE = TripUpdate_StopTimeUpdate_OccupancyStatus._(1, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'MANY_SEATS_AVAILABLE');
  static const TripUpdate_StopTimeUpdate_OccupancyStatus FEW_SEATS_AVAILABLE = TripUpdate_StopTimeUpdate_OccupancyStatus._(2, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'FEW_SEATS_AVAILABLE');
  static const TripUpdate_StopTimeUpdate_OccupancyStatus STANDING_ROOM_ONLY = TripUpdate_StopTimeUpdate_OccupancyStatus._(3, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'STANDING_ROOM_ONLY');
  static const TripUpdate_StopTimeUpdate_OccupancyStatus CRUSHED_STANDING_ROOM_ONLY = TripUpdate_StopTimeUpdate_OccupancyStatus._(4, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'CRUSHED_STANDING_ROOM_ONLY');
  static const TripUpdate_StopTimeUpdate_OccupancyStatus FULL = TripUpdate_StopTimeUpdate_OccupancyStatus._(5, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'FULL');
  static const TripUpdate_StopTimeUpdate_OccupancyStatus NOT_ACCEPTING_PASSENGERS = TripUpdate_StopTimeUpdate_OccupancyStatus._(6, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'NOT_ACCEPTING_PASSENGERS');

  static const $core.List<TripUpdate_StopTimeUpdate_OccupancyStatus> values = <TripUpdate_StopTimeUpdate_OccupancyStatus> [
    EMPTY,
  ...
  static final $core.Map<$core.int, TripUpdate_StopTimeUpdate_OccupancyStatus> _byValue = $pb.ProtobufEnum.initByValue(values);
  static TripUpdate_StopTimeUpdate_OccupancyStatus? valueOf($core.int value) => _byValue[value];

  const TripUpdate_StopTimeUpdate_OccupancyStatus._($core.int v, $core.String n) : super(v, n);
}
...
class CarriageDescriptor_OccupancyStatus extends $pb.ProtobufEnum {
  static const CarriageDescriptor_OccupancyStatus EMPTY = CarriageDescriptor_OccupancyStatus._(0, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'EMPTY');
  static const CarriageDescriptor_OccupancyStatus MANY_SEATS_AVAILABLE = CarriageDescriptor_OccupancyStatus._(1, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'MANY_SEATS_AVAILABLE');
  static const CarriageDescriptor_OccupancyStatus FEW_SEATS_AVAILABLE = CarriageDescriptor_OccupancyStatus._(2, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'FEW_SEATS_AVAILABLE');
  static const CarriageDescriptor_OccupancyStatus STANDING_ROOM_ONLY = CarriageDescriptor_OccupancyStatus._(3, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'STANDING_ROOM_ONLY');
  static const CarriageDescriptor_OccupancyStatus CRUSHED_STANDING_ROOM_ONLY = CarriageDescriptor_OccupancyStatus._(4, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'CRUSHED_STANDING_ROOM_ONLY');
  static const CarriageDescriptor_OccupancyStatus FULL = CarriageDescriptor_OccupancyStatus._(5, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'FULL');
  ...
  const CarriageDescriptor_OccupancyStatus._($core.int v, $core.String n) : super(v, n);
}

class CarriageDescriptor_ToiletStatus extends $pb.ProtobufEnum {
  static const CarriageDescriptor_ToiletStatus NONE = CarriageDescriptor_ToiletStatus._(0, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'NONE');
  static const CarriageDescriptor_ToiletStatus NORMAL = CarriageDescriptor_ToiletStatus._(1, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'NORMAL');
  static const CarriageDescriptor_ToiletStatus ACCESSIBLE = CarriageDescriptor_ToiletStatus._(2, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'ACCESSIBLE');
  ...
  const CarriageDescriptor_ToiletStatus._($core.int v, $core.String n) : super(v, n);
}
