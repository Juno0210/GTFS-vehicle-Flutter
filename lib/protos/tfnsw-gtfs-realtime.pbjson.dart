...
const TrackDirection$json = const {
  '1': 'TrackDirection',
  '2': const [
    const {'1': 'UP', '2': 0},
    const {'1': 'DOWN', '2': 1},
...
final $typed_data.Uint8List trackDirectionDescriptor = $convert.base64Decode('Cg5UcmFja0RpcmVjdGlvbhIGCgJVUBAAEggKBERPV04QAQ==');
...
const TripUpdate_StopTimeUpdate$json = const {
  ...
  '2': const [
    ...
    const {'1': 'departure_occupancy_status', '3': 6, '4': 1, '5': 14, '6': '.transit_realtime.TripUpdate.StopTimeUpdate.OccupancyStatus', '10': 'departureOccupancyStatus'},
  ],
  '4': const [TripUpdate_StopTimeUpdate_ScheduleRelationship$json, TripUpdate_StopTimeUpdate_OccupancyStatus$json],
  '5': const [
    const {'1': 1000, '2': 2000},
  ],
};
...
@$core.Deprecated('Use tripUpdateDescriptor instead')
const TripUpdate_StopTimeUpdate_OccupancyStatus$json = const {
  '1': 'OccupancyStatus',
  '2': const [
    const {'1': 'EMPTY', '2': 0},
...
final $typed_data.Uint8List tripUpdateDescriptor = $convert.base64Decode('');
...
const Alert$json = const {
  ...
  '2': const [
    ...
    const {'1': 'severity_level', '3': 14, '4': 1, '5': 14, '6': '.transit_realtime.Alert.SeverityLevel', '10': 'severityLevel'},
  ],
...
final $typed_data.Uint8List alertDescriptor = $convert.base64Decode('');
@$core.Deprecated('Use updateBundleDescriptor instead')
const UpdateBundle$json = const {
  '1': 'UpdateBundle',
  '2': const [
    const {'1': 'GTFSStaticBundle', '3': 1, '4': 2, '5': 9, '10': 'GTFSStaticBundle'},
    const {'1': 'update_sequence', '3': 2, '4': 2, '5': 5, '10': 'updateSequence'},
    const {'1': 'cancelled_trip', '3': 4, '4': 3, '5': 9, '10': 'cancelledTrip'},
  ],
};

/// Descriptor for `UpdateBundle`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List updateBundleDescriptor = $convert.base64Decode('CgxVcGRhdGVCdW5kbGUSKgoQR1RGU1N0YXRpY0J1bmRsZRgBIAIoCVIQR1RGU1N0YXRpY0J1bmRsZRInCg91cGRhdGVfc2VxdWVuY2UYAiACKAVSDnVwZGF0ZVNlcXVlbmNlEiUKDmNhbmNlbGxlZF90cmlwGAQgAygJUg1jYW5jZWxsZWRUcmlw');
...
const TripDescriptor_ScheduleRelationship$json = const {
  ...
  '2': const [
    ...
    const {'1': 'REPLACEMENT', '2': 5},
  ],
};

/// Descriptor for `TripDescriptor`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List tripDescriptorDescriptor = $convert.base64Decode('');
...
const TfnswVehicleDescriptor$json = const {
  '1': 'TfnswVehicleDescriptor',
  '2': const [
    const {'1': 'air_conditioned', '3': 1, '4': 1, '5': 8, '7': 'false', '10': 'airConditioned'},
    const {'1': 'wheelchair_accessible', '3': 2, '4': 1, '5': 5, '7': '0', '10': 'wheelchairAccessible'},
    const {'1': 'vehicle_model', '3': 3, '4': 1, '5': 9, '10': 'vehicleModel'},
    const {'1': 'performing_prior_trip', '3': 4, '4': 1, '5': 8, '7': 'false', '10': 'performingPriorTrip'},
    const {'1': 'special_vehicle_attributes', '3': 5, '4': 1, '5': 5, '7': '0', '10': 'specialVehicleAttributes'},
  ],
};

/// Descriptor for `TfnswVehicleDescriptor`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List tfnswVehicleDescriptorDescriptor = $convert.base64Decode('');
@$core.Deprecated('Use carriageDescriptorDescriptor instead')
const CarriageDescriptor$json = const {
  '1': 'CarriageDescriptor',
  '2': const [
    const {'1': 'name', '3': 1, '4': 1, '5': 9, '10': 'name'},
    const {'1': 'position_in_consist', '3': 2, '4': 2, '5': 5, '10': 'positionInConsist'},
    const {'1': 'occupancy_status', '3': 3, '4': 1, '5': 14, '6': '.transit_realtime.CarriageDescriptor.OccupancyStatus', '10': 'occupancyStatus'},
    const {'1': 'quiet_carriage', '3': 4, '4': 1, '5': 8, '7': 'false', '10': 'quietCarriage'},
    const {'1': 'toilet', '3': 5, '4': 1, '5': 14, '6': '.transit_realtime.CarriageDescriptor.ToiletStatus', '10': 'toilet'},
    const {'1': 'luggage_rack', '3': 6, '4': 1, '5': 8, '7': 'false', '10': 'luggageRack'},
    const {'1': 'departure_occupancy_status', '3': 7, '4': 1, '5': 14, '6': '.transit_realtime.CarriageDescriptor.OccupancyStatus', '10': 'departureOccupancyStatus'},
  ],
  '4': const [CarriageDescriptor_OccupancyStatus$json, CarriageDescriptor_ToiletStatus$json],
  '5': const [
    const {'1': 1000, '2': 2000},
  ],
};
...
@$core.Deprecated('Use carriageDescriptorDescriptor instead')
const CarriageDescriptor_OccupancyStatus$json = const {
  '1': 'OccupancyStatus',
  '2': const [
    const {'1': 'EMPTY', '2': 0},
    const {'1': 'MANY_SEATS_AVAILABLE', '2': 1},
...
@$core.Deprecated('Use carriageDescriptorDescriptor instead')
const CarriageDescriptor_ToiletStatus$json = const {
  '1': 'ToiletStatus',
  '2': const [
    const {'1': 'NONE', '2': 0},
    const {'1': 'NORMAL', '2': 1},
    const {'1': 'ACCESSIBLE', '2': 2},
  ],
};

/// Descriptor for `CarriageDescriptor`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List carriageDescriptorDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List entitySelectorDescriptor = $convert.base64Decode('');
